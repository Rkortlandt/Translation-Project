...
import { IModes } from "./Interfaces/IModes.js";
 ...
 */
export function handleAddLineSegment(canvasMousePos, canvas : any, ptx : any, ltx : any, gridSpacing : number, pointsSelectedLineSeg : number, line : HTMLElement, ttx : any, selectedPointA: IElement, selectedPointB: IElement, modes: IModes) {
    let mfreeLocation = isMatchingPoint(canvasMousePos, canvas, ptx, gridSpacing);
